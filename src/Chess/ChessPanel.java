 ...
 *****************************************************************************************/
 public ChessPanel() {
    ...
    /**************************************************************************************
     * This method sets the background color to white or black of each respective JButton
     * in the button array
    ...
    /**************************************************************************************
     * This method adds an action listener and sets and ImageIcon for each respective
     * white piece
    ...
    /**************************************************************************************
     * This method loads PNG image files from the project folder and assigns them to
     * respective chess pieces
     *************************************************************************************/
    ...
    /**************************************************************************************
     * This class contains a method that contains many if statement and loops to determine
     * things like if you picked a valid move, if the you've reached the other endzone,
     * if the AI is on, and also runs certain methods from the model class if the
                    ...
                    if (board[r][c] == event.getSource()) {
                        if (firstTurnFlag == true) {
                            ...
                            if (model.pieceAt(r, c) != null)
                                ...
                                //If you clicked on an invalid piece, text set to
                                // Selected empty
                            ...
                            if ((model.isValidMove(m)) == true) {
                                ...
                                if (model.pawnInEndzone()) {
                                    ...
                                    //Opens JOptionPane with four buttons for
                                    // transformation options
                                    int type =
                                            JOptionPane.showOptionDialog
                                                    (null,
                                            "What do you want your " +
                                                    "pawn to transform into?",
                                            "Pawn transformation",
